...
(function ($) {
     ...
     * @returns {boolean}
     */
    $.File.wjson = function (data, filepath, localpath=true) {
        if (typeof filepath !== 'string') return false;
        if (!($.Utils.isObject(data))) return false;
        filepath = /.json$/i.test(filepath) ? filepath : filepath + ".json";
        let local = localpath ? $.File.local(filepath) : filepath;
    ...
    /**
     * @desc return the next element from 'array'
     * @param {array} array
     * @param {number} index 
     * @return {*} 
     */
    $.Utils.Array.next = function (array, index) {
        return array[
            $.DMath.fincrease(index, 0, array.length - 1, 1)
        ];
    }
    /**
     * @desc return the previous element from 'array'
     * @param {array} array
     * @param {element} current keyname
     * @return {*}
     */
    $.Utils.Object.pred = function (array, index) {
        return array[
            $.DMath.fdecrease(index, 0, array.length - 1, 1)
        ];
    }
    /**
    ...
    /**
     * @const FRGB
     * @description constant that represents the value of 1/255
     */
    $.DMath.FRGB = 0.003921569
    /**
    ...
    $.DMath.lerp = function (from, to, by) {
    ...
    /**
     * Removes all children from a container or sprite
     * @param {PIXI.Container|PIXI.Sprite} object 
     */
    $.Pixi.Manager.removeChildren = function (object) {
