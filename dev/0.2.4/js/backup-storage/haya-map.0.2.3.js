 ...
 *  @version 0.2.3
 *      [] : Sprite_Light class for a better organization
 *          [] : Pulse effect
 *          [] : Oscilation
 * =====================================================================
 */
...
(function ($) {
    ...
    Sprite_Light.prototype.refresh = function () {
        ...
        this.pulse.time = this.pulse.duration;
    }

    Sprite_Light.prototype.isOkay = function () {
        return ((this.switch !== -1 ? $gameSwitches.value(this.switch) : true) && $.Time.period(this.time))
    }

    Sprite_Light.prototype.atRange = function (margin = 120) {
        return (
    ...
    Pixi_Light.prototype.isOkay = function () {
        return ((this.switch !== -1 ? $gameSwitches.value(this.switch) : true) && $.Time.period(this.sprite.time))
    }

    Pixi_Light.prototype.atRange = function (margin = 120) {
        return (
            (this.sprite.x.isBetween(
                -margin + ($.Viewport.x),
                (Graphics.width) + ($.Viewport.x + margin))
    ...
    Sprite_Map.prototype.createMap = function () {
        if ($.current.sprite.length > 0) this.sprite.addChild(...$.current.sprite);
    }
