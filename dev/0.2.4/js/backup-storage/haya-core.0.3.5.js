...
(function ($) {
    ...
    */
     ...
     * @return {string}
     */
    $.File.local = function (pathname) { return path.dirname(process.mainModule.filename).join(localDirBase, pathname); }
    /**
    ...
    $.File.exist = function (path, local = true) {
        return (fs.existsSync(local ? Haya.FileIO.local(path) : path));
    }
