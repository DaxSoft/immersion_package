 ...
 * 
 * @plugindesc [0.1.7] Haya Movement | Organic Movement 
 * 
 * @help
...
(function ($) {
    ...
    function setStateBody(data, parent) {
        ...
        if (data.type === "circle") {
            ...
            if ($.collision === undefined || $.collision === null) {
                ...
                body = $.collision.createCircle(0, 0, data.width, data.height);
            }
    ...
    Scene_Map.prototype.playerCollision = function () {
        ...
        for (const wall of player_potentials) {
            if (wall.floor !== $gamePlayer._collision.body.floor) continue;
