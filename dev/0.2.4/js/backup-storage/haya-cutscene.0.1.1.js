...
(function ($) {
    ...
    Game_Cutscene.prototype.update = function () {
        ...
        } else { this._focusLight.visible = false }
    ...
    Game_Cutscene.prototype.refresh = function () {
        ...
        this._period = 0;
        this._speed = { value: 0.75, standard: 0.9, fast: 3.0, slow: 0.5, refresh: 1.0 }
        this._zoom = { value: 1.0, target: null }
        this._blur = { current: null, data: [], duration: null, strength: 1, quality: 1 }
        this._zoomIn = true;
